...
ty_rect :: a1 -> a1 -> a1 -> (Datatypes.Coq_nat -> Coq_ty -> a1 -> a1) ->
           (Coq_ty -> a1 -> Coq_ty -> a1 -> a1) -> (Coq_ty -> a1 -> Coq_ty ->
           a1 -> a1) -> (Coq_ty -> a1 -> Coq_ty -> a1 -> a1) -> Coq_ty -> a1
ty_rect f f0 f1 f2 f3 f4 f5 t =
  case t of {
   Real -> f;
   Bool -> f0;
   Nat -> f1;
   Array n t0 -> f2 n t0 (ty_rect f f0 f1 f2 f3 f4 f5 t0);
   Arrow t0 t1 ->
    f3 t0 (ty_rect f f0 f1 f2 f3 f4 f5 t0) t1
      (ty_rect f f0 f1 f2 f3 f4 f5 t1);
   Prod t0 t1 ->
    f4 t0 (ty_rect f f0 f1 f2 f3 f4 f5 t0) t1
      (ty_rect f f0 f1 f2 f3 f4 f5 t1);
   Sum t0 t1 ->
    f5 t0 (ty_rect f f0 f1 f2 f3 f4 f5 t0) t1
      (ty_rect f f0 f1 f2 f3 f4 f5 t1)}

ty_rec :: a1 -> a1 -> a1 -> (Datatypes.Coq_nat -> Coq_ty -> a1 -> a1) ->
          (Coq_ty -> a1 -> Coq_ty -> a1 -> a1) -> (Coq_ty -> a1 -> Coq_ty ->
          a1 -> a1) -> (Coq_ty -> a1 -> Coq_ty -> a1 -> a1) -> Coq_ty -> a1
ty_rec =
  ty_rect
...
data Coq_tm =
 ...
 | Coq_tru
 | Coq_fls
 | Coq_ifelse Coq_ty Coq_tm Coq_tm Coq_tm
 | Coq_rlt Coq_tm
...
tm_rect :: ((Ctx Coq_ty) -> Coq_ty -> (Var Coq_ty) -> a1) -> ((Ctx Coq_ty) ->
           ...
           Coq_ty) -> a1) -> ((Ctx Coq_ty) -> a1) -> ((Ctx Coq_ty) -> Coq_ty
           -> Coq_tm -> a1 -> Coq_tm -> a1 -> Coq_tm -> a1 -> a1) -> ((Ctx
           Coq_ty) -> Coq_tm -> a1 -> a1) -> ((Ctx Coq_ty) -> Coq_ty ->
           Datatypes.Coq_nat -> (Fin.Coq_t -> Coq_tm) -> (Fin.Coq_t -> a1) ->
           a1) -> ((Ctx Coq_ty) -> Coq_ty -> Datatypes.Coq_nat -> Fin.Coq_t
           -> Coq_tm -> a1 -> a1) -> ((Ctx Coq_ty) ->
           Rdefinitions.RbaseSymbolsImpl__R -> a1) -> ((Ctx Coq_ty) -> Coq_tm
           -> a1 -> Coq_tm -> a1 -> a1) -> ((Ctx Coq_ty) -> Coq_tm -> a1 ->
           Coq_tm -> a1 -> a1) -> ((Ctx Coq_ty) -> Coq_tm -> a1 -> a1) ->
           ((Ctx Coq_ty) -> Datatypes.Coq_nat -> a1) -> ((Ctx Coq_ty) ->
           Coq_ty -> Coq_tm -> a1 -> Coq_tm -> a1 -> Coq_tm -> a1 -> a1) ->
           ((Ctx Coq_ty) -> Coq_ty -> Coq_ty -> Coq_tm -> a1 -> Coq_tm -> a1
           -> a1) -> ((Ctx Coq_ty) -> Coq_ty -> Coq_ty -> Coq_tm -> a1 -> a1)
           -> ((Ctx Coq_ty) -> Coq_ty -> Coq_ty -> Coq_tm -> a1 -> a1) ->
           ((Ctx Coq_ty) -> Coq_ty -> Coq_ty -> Coq_ty -> Coq_tm -> a1 ->
           Coq_tm -> a1 -> Coq_tm -> a1 -> a1) -> ((Ctx Coq_ty) -> Coq_ty ->
           Coq_ty -> Coq_tm -> a1 -> a1) -> ((Ctx Coq_ty) -> Coq_ty -> Coq_ty
           -> Coq_tm -> a1 -> a1) -> (Ctx Coq_ty) -> Coq_ty -> Coq_tm -> a1
tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17 f18 f19 _UU0393_ _ t =
  case t of {
   ...
   Coq_app _UU03c4_ _UU03c3_ t0 t1 ->
    f0 _UU0393_ _UU03c4_ _UU03c3_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ (Arrow _UU03c3_ _UU03c4_) t0) t1
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ _UU03c3_ t1);
   Coq_abs _UU03c4_ _UU03c3_ t0 ->
    f1 _UU0393_ _UU03c4_ _UU03c3_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 (Datatypes.Coq_cons _UU03c3_ _UU0393_) _UU03c4_ t0);
   Coq_tru -> f2 _UU0393_;
   Coq_fls -> f3 _UU0393_;
   Coq_ifelse _UU03c4_ t0 t1 t2 ->
    f4 _UU0393_ _UU03c4_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ Bool t0) t1
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ _UU03c4_ t1) t2
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ _UU03c4_ t2);
   Coq_rlt t0 ->
    f5 _UU0393_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ Real t0);
   Coq_build _UU03c4_ n t0 ->
    f6 _UU0393_ _UU03c4_ n t0 (\t1 ->
      tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 f17
        f18 f19 _UU0393_ _UU03c4_ (t0 t1));
   Coq_get _UU03c4_ n t0 t1 ->
    f7 _UU0393_ _UU03c4_ n t0 t1
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ (Array n _UU03c4_) t1);
   Coq_rval r -> f8 _UU0393_ r;
   Coq_add t0 t1 ->
    f9 _UU0393_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ Real t0) t1
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ Real t1);
   Coq_mul t0 t1 ->
    f10 _UU0393_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ Real t0) t1
   ...
   Coq_nsucc t0 ->
    f11 _UU0393_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ Nat t0);
   Coq_nval n -> f12 _UU0393_ n;
   Coq_nrec _UU03c4_ t0 t1 t2 ->
    f13 _UU0393_ _UU03c4_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ (Arrow _UU03c4_ _UU03c4_) t0) t1
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ Nat t1) t2
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ _UU03c4_ t2);
   Coq_tuple _UU03c4_ _UU03c3_ t0 t1 ->
    f14 _UU0393_ _UU03c4_ _UU03c3_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ _UU03c4_ t0) t1
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ _UU03c3_ t1);
   Coq_first _UU03c4_ _UU03c3_ t0 ->
    f15 _UU0393_ _UU03c4_ _UU03c3_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ (Prod _UU03c4_ _UU03c3_) t0);
   Coq_second _UU03c4_ _UU03c3_ t0 ->
    f16 _UU0393_ _UU03c4_ _UU03c3_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ (Prod _UU03c4_ _UU03c3_) t0);
   Coq_case _UU03c4_ _UU03c3_ _UU03c1_ t0 t1 t2 ->
    f17 _UU0393_ _UU03c4_ _UU03c3_ _UU03c1_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ (Sum _UU03c4_ _UU03c3_) t0) t1
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ (Arrow _UU03c4_ _UU03c1_) t1) t2
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ (Arrow _UU03c3_ _UU03c1_) t2);
   Coq_inl _UU03c4_ _UU03c3_ t0 ->
    f18 _UU0393_ _UU03c4_ _UU03c3_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ _UU03c4_ t0);
   Coq_inr _UU03c4_ _UU03c3_ t0 ->
    f19 _UU0393_ _UU03c4_ _UU03c3_ t0
      (tm_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
        f17 f18 f19 _UU0393_ _UU03c3_ t0)}
...
data Env =
   Coq_env_nil
 | Coq_env_cons (Ctx Coq_ty) Coq_ty Coq_tm Env

coq_Env_rect :: a1 -> ((Ctx Coq_ty) -> Coq_ty -> Coq_tm -> Env -> a1 -> a1)
                -> (Ctx Coq_ty) -> Env -> a1
coq_Env_rect f f0 _ e =
  case e of {
   Coq_env_nil -> f;
   Coq_env_cons _UU0393_ _UU03c4_ t e0 ->
    f0 _UU0393_ _UU03c4_ t e0 (coq_Env_rect f f0 _UU0393_ e0)}

coq_Env_rec :: a1 -> ((Ctx Coq_ty) -> Coq_ty -> Coq_tm -> Env -> a1 -> a1) ->
               (Ctx Coq_ty) -> Env -> a1
coq_Env_rec =
  coq_Env_rect
...
coq_Env_sig_pack :: (Ctx Coq_ty) -> Env -> ( * ) (Ctx Coq_ty) Env
coq_Env_sig_pack x env_var =
  (,) x env_var

coq_Env_Signature :: (Ctx Coq_ty) -> Signature.Signature Env (Ctx Coq_ty)
                     Env_sig
coq_Env_Signature x env_var =
  (,) x env_var
...
rename _UU0393_ _UU0393_' _ r t =
  case t of {
   ...
   Coq_ifelse _UU03c4_0 b t0 f -> Coq_ifelse _UU03c4_0
    (rename _UU0393_ _UU0393_' Bool r b)
    (rename _UU0393_ _UU0393_' _UU03c4_0 r t0)
    (rename _UU0393_ _UU0393_' _UU03c4_0 r f);
   Coq_rlt t1 -> Coq_rlt (rename _UU0393_ _UU0393_' Real r t1);
...
substitute _UU0393_ _UU0393_' _ s t =
  case t of {
   ...
   Coq_ifelse _UU03c4_0 b t0 f -> Coq_ifelse _UU03c4_0
    (substitute _UU0393_ _UU0393_' Bool s b)
    (substitute _UU0393_ _UU0393_' _UU03c4_0 s t0)
    (substitute _UU0393_ _UU0393_' _UU03c4_0 s f);
   Coq_rlt t1 -> Coq_rlt (substitute _UU0393_ _UU0393_' Real s t1);
   Coq_build _UU03c4_0 n ta -> Coq_build _UU03c4_0 n
