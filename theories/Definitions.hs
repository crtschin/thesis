...
shave_env :: (Datatypes.Coq_list Coq_ty) -> Coq_ty -> Env -> Env
shave_env _UU0393_ _UU03c4_ g =
  case g of {
   Coq_env_nil -> Logic.coq_False_rect;
   Coq_env_cons _UU0393_0 _UU03c4_0 t e ->
    Logic0.transport _UU03c4_ _UU03c4_0 (\t0 e0 _ ->
      Logic0.transport _UU0393_ _UU0393_0 (\_ e1 -> e1) t0 e0) t e __}

data Coq_shave_env_graph =
   Coq_shave_env_graph_equation_1 (Ctx Coq_ty) Coq_ty Coq_tm Env

shave_env_graph_rect :: ((Ctx Coq_ty) -> Coq_ty -> Coq_tm -> Env -> a1) ->
                        (Datatypes.Coq_list Coq_ty) -> Coq_ty -> Env -> Env
                        -> Coq_shave_env_graph -> a1
shave_env_graph_rect f _ _ _ _ s =
  case s of {
   Coq_shave_env_graph_equation_1 _UU0393_0 _UU03c4_0 t e ->
    f _UU0393_0 _UU03c4_0 t e}

shave_env_graph_correct :: (Datatypes.Coq_list Coq_ty) -> Coq_ty -> Env ->
                           Coq_shave_env_graph
shave_env_graph_correct _UU0393_ _UU03c4_ g =
  let {g0 = (,) (Datatypes.Coq_cons _UU03c4_ _UU0393_) g} in
  case Init0.pr2 g0 of {
   Coq_env_nil -> Logic0.coq_False_rect_dep __;
   Coq_env_cons _ _ t g1 ->
    Logic0.transport (Coq_env_cons _UU0393_ _UU03c4_ t g1) g
      (Logic.eq_rect_r g1 (Coq_shave_env_graph_equation_1 _UU0393_ _UU03c4_ t
        g1)
        (shave_env _UU0393_ _UU03c4_ (Coq_env_cons _UU0393_ _UU03c4_ t g1)))}

shave_env_elim :: ((Ctx Coq_ty) -> Coq_ty -> Coq_tm -> Env -> a1) ->
                  (Datatypes.Coq_list Coq_ty) -> Coq_ty -> Env -> a1
shave_env_elim f _UU0393_ _UU03c4_ g =
  shave_env_graph_rect f _UU0393_ _UU03c4_ g (shave_env _UU0393_ _UU03c4_ g)
    (shave_env_graph_correct _UU0393_ _UU03c4_ g)

coq_FunctionalElimination_shave_env :: ((Ctx Coq_ty) -> Coq_ty -> Coq_tm ->
                                       Env -> a1) -> (Datatypes.Coq_list
                                       Coq_ty) -> Coq_ty -> Env -> a1
coq_FunctionalElimination_shave_env =
  shave_env_elim

coq_FunctionalInduction_shave_env :: Classes.FunctionalInduction
                                     ((Datatypes.Coq_list Coq_ty) -> Coq_ty
                                     -> Env -> Env)
coq_FunctionalInduction_shave_env =
  unsafeCoerce shave_env_graph_correct
