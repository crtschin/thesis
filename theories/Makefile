...
CoqMakefile.conf: 
	coq_makefile -Q . AD Continuation.v CpdtTactics.v Definitions.v Denotation.v DepList.v Direct.v Macro.v Natural.v Normalization.v Rewrite.v Simply.v Tactics.v
