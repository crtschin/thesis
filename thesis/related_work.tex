...
% Abadi and Plotkin\cite{10.1145/3371106} also make use of reverse-mode AD primitives, and do so in the context of a define-by-run trace-based algorithm.
% TODO: Explain \cite{10.1145/3371106} better
