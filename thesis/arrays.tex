\subsection{Arrays}
  ...
  Note that in the definition of $vect$, the $Fin$ and $nat$ types are treated interchangeably, where $\Fin{n}$ is interpreted as $n$.
  The recursive call to $vect$ also transforms the function by incrementing the bounded integer given as its argument.
