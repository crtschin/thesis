\subsection{Simply Typed Lambda Calculus}\label{sec:formal_stlc}
  ...
  \begin{corrollary}[Fundamental property]\label{thm:fundamental_property}
  ...
  \begin{proof}
    This follows from the substitution lemma. We lastly need to prove $\inst{(\synRepeat{\synR}{n})}$.
