...
CoqMakefile.conf: 
	coq_makefile -Q . AD Adequacy.v Base.v coquelicotComplements.v CpdtTactics.v Definitions.v Denotation.v DepList.v Diffeology.v Direct.v Domain.v Imp.v Macro.v Natural.v Normalization.v Semantics.v Syntactic.v Tactics.v Tangent.v vect.v
