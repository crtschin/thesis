...
CoqMakefile.conf: 
	coq_makefile -Q . AD Adequacy.v Base.v Definitions.v Denotation.v Diffeology.v Direct.v Domain.v Macro.v Normalization.v Semantics.v Syntactic.v Tactics.v Tangent.v domain/*.v
