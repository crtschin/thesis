...
CoqMakefile.conf: 
	coq_makefile -Q . AD Adequacy.v Base.v Continuation.v coquelicotComplements.v CpdtTactics.v Definitions.v Denotation.v DepList.v Diffeology.v Direct.v Ext.v Imp.v Macro.v Natural.v Normalization.v Rewrite.v Semantics.v Syntactic.v Tactics.v Tangent.v vect.v
