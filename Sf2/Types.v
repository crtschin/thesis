...
Proof.
  ...
  - induction H; intros.
    ...
    + apply IHnvalue. inversion H0. inversion H1.
      exists t1'. apply H3.
Qed.
...
Proof with auto.
  ...
  - inversion IHHT; clear IHHT.
    + inversion H; subst.
      ...
      * left...
    + destruct H.
      right. exists (scc x). apply ST_Scc. apply H.
  - destruct IHHT.
    + destruct H.
      * left. inversion H; subst; inversion HT.
      * inversion H.
        { right. exists zro. apply ST_PrdZro. }
        { right. exists t. apply ST_PrdScc. apply H0. }
    + destruct H.
      * right. exists (prd x). apply ST_Prd. apply H.
  - destruct IHHT.
    + destruct H.
      * inversion H; subst; inversion HT.
      * inversion H; subst.
        { right. exists tru. constructor. }
        { right. exists fls. constructor. apply H0. }
    + destruct H.
      right. exists (iszro x). constructor. assumption.
Qed.
