...
Proof.
  ...
  - inversion H2. subst. apply IHHy1 in H4. rewrite H4. reflexivity.
Qed.
...
Proof.
  ...
  - intros. apply nf_is_value in P12. apply nf_is_value in P22.
    inversion P12 as [n1]. inversion P22 as [n2].
    subst. inversion P21. reflexivity. inversion H.

  - intros. apply IHP11.
      + assumption.
      + inversion P21. subst.
        apply nf_is_value in P22. inversion P22. subst.
        inversion H. subst.
        assert  (y = y0).
        * eapply step_deterministic. apply H. assumption.
        * symmetry in H2. subst. assumption.
      + assumption.
Qed.
...
Proof.
  ...
  - apply IHmulti in H0.
    inversion H0.
    inversion H2.
    apply step__eval with (n:=x0) in H.
    exists x0. split.
    + apply H2.
    + apply H.
    + apply H2.
