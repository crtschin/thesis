...
Proof.
  ...
  - generalize dependent t'.
    ...
    + destruct (eqb_string x0 s0) eqn:E in H; subst.
      * apply eqb_string_true_iff in E. rewrite E.
        apply s_var1.
      * apply eqb_string_false_iff in E.
        apply s_var2 with (s:=s) in E.
        assumption.
    + subst. constructor.
      * apply IHt1. reflexivity.
      * apply IHt2. reflexivity.
    + subst. destruct (eqb_string x0 s0) eqn:E.
      * apply eqb_string_true_iff in E. subst.
        apply s_abs1.
      * apply eqb_string_false_iff in E.
        apply s_abs2. apply E. apply IHt. reflexivity.
    + subst. constructor.
    + subst. constructor.
    + subst. apply s_test.
      * apply IHt1. reflexivity.
  ...
  - generalize dependent t'.
    ...
    + inversion H; subst.
      * rewrite <- eqb_string_refl. reflexivity.
      * apply eqb_string_false_iff in H4. rewrite H4.
    ...
    + inversion H; subst.
      ...
      apply IHt3 in H6. rewrite H6. reflexivity.
Qed.
